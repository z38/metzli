...
namespace Metzli\Tests\Encoder\ReedSolomon;
...
{
    public function testAztec()
    {
        $this->encodeTest(GenericGF::AZTEC_PARAM, array(
            0x5, 0x6,
        ), array(
            0x3, 0x2, 0xB, 0xB, 0x7,
        ));
        ...
        $this->encodeTest(GenericGF::AZTEC_DATA_10, array(
        ...
        $this->encodeTest(GenericGF::AZTEC_DATA_12, array(
